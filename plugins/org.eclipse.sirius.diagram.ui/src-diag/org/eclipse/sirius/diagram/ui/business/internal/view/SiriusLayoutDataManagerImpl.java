...
public final class SiriusLayoutDataManagerImpl implements SiriusLayoutDataManager {
    ...
    public EdgeLayoutData getOppositeEdgeLayoutData(EdgeLayoutData edgeLayoutData, boolean searchParent) {
        ...
        return getData(edge, searchParent, java.util.Optional.of(edgeLayoutData));
    }

    private EdgeLayoutData getData(DEdge edge, boolean searchParent, java.util.Optional<EdgeLayoutData> optionalOppositeEdgeLayoutData) {
        ...
        if (result == null) {
            ...
            for (final AbstractLayoutData abstractLayoutData : rootsLayoutData) {
                if (abstractLayoutData instanceof LayoutData) {
                    ...
                    if (result != null && (!optionalOppositeEdgeLayoutData.isPresent() || !(optionalOppositeEdgeLayoutData.get().equals(result)))) {
                        break;
                    }
                } else if (abstractLayoutData instanceof EdgeLayoutData && (!optionalOppositeEdgeLayoutData.isPresent() || !(optionalOppositeEdgeLayoutData.get().equals(abstractLayoutData)))) {
                    EdgeLayoutData edgeLayoutData = (EdgeLayoutData) abstractLayoutData;
